var rule = {
    ...
    play_parse:true,
    lazy:$js.toString(() => {
        var html = 'http://27.188.68.230:808/PlayMov.asp?ClassId=' + input.split(",")[2] + '&video=2&exe=0&down=0&movNo=' + input.split(",")[3] + '&vgver=undefined&ClientIP=114.100.48.52'
